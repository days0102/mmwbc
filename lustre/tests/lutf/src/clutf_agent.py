...
LUTF_AGENT_ZOMBIE = _clutf_agent.LUTF_AGENT_ZOMBIE
...
def free_agent_blk(id):
    return _clutf_agent.free_agent_blk(id)

def acquire_agent_blk(agent):
    return _clutf_agent.acquire_agent_blk(agent)

def release_agent_blk(agent):
    return _clutf_agent.release_agent_blk(agent)

def agent_ip2str(agent):
    return _clutf_agent.agent_ip2str(agent)

def agent_hb_check(t, whoami):
    return _clutf_agent.agent_hb_check(t, whoami)
